...
class PointsProcessor:
    ...
    def grant(self, message):
        ...
        self.points_db.grant_points(
            ...
            note=parsed[3],
            deduct_from=False)
        return f"<@{message.author.id}> granted ${parsed[2]} to <@{parsed[1]}>!"
    ...
    def give(self, message):
        ...
        self.points_db.grant_points(
            ...
            note=parsed[3],
            deduct_from=True)
        return f"Gave ${parsed[2]} from <@{message.author.id}> to <@{parsed[1]}>!"
    ...
    def take(self, message):
        ...
        self.points_db.take_points(
            ...
            command="!take",
            note=parsed[3])
        return (f"<@{message.author.id}> Took {parsed[2]} "
...
!gran[t] @User 100 - Give @User $100 from the bank.

!give @User 100 - Give @User $100 of your money.
!send @User 100 - Alias of !give.

!take @User 100 - Take $100 of @User's money and give it to the bank.
